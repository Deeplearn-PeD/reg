...
class Database:
    ...
    def get_table_description(self, table_name: str) -> List[Dict[str, Any]]:
        ...
        parsed_result = self._parse_table_description(result)
        self.table_descriptions[table_name] = parsed_result

        return parsed_result

    def _parse_table_description(self, table_description: str) -> str:
        """
        ...
        for column in table_description:
            description += f"{column[0]}: {column[1]}\n"
        return description
    ...
    def run_query(self, query, table_name: str):
        ...
        while tries < 5:
            try:
                ...
                self.debug_query(sqlcode, table_name)
                tries += 1
